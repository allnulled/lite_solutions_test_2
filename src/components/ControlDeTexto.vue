<template>
  <div class="component ControlDeTexto">
    <input v-model="value" :class="classes" type="text" :placeholder="placeholder" :min="min" :max="max" />
    <div class="validation_text" :class="state">
        ...
        <span>{{ value_length }}/{{ max }} (mín. {{ min }})</span>
    </div>
  </div>
</template>
<script>
